### What i have done?
- used default vpcs and subnets: This will not allow ec2 creation
- Fix: Try setup folder main.tf to create infrastructure first and replace t2.micro with t3.micro: This works
- Also Added Backup for tef state file in s3 bucket
