...
## Major fix in this branch
added line to EC2 instance to replace app logic when user_data.sh is updated
```
...
Still you need to give below command manually for the first time
```bash
...
- [FUTURE.md](FUTURE.md) – Future Improvements
